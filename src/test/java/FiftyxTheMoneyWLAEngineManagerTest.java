...
public class FiftyxTheMoneyWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(FiftyxTheMoneyWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/50xTheMoneyIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/50xTheMoneyIW/InitOutcome.xml").getDocumentElement();
